...
import com.nb6868.xquick.entity.ColumnEntity;
import com.nb6868.xquick.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		for(String template : templates){
			...
			try {
				...
				throw new XquickException("渲染模板失败，表名：" + tableEntity.getTableName(), e);
			}
		}
	}
	...
	public static Configuration getConfig(){
		try {
			...
			throw new XquickException("获取配置文件失败，", e);
		}
	}
