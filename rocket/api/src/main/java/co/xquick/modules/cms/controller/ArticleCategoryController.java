...
import co.xquick.modules.cms.excel.ArticleCategoryExcel;
...
public class ArticleCategoryController {
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("cms:articleCategory:export")
    public void export(@ApiIgnore @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<ArticleCategoryDTO> list = articleCategoryService.listDto(params);

        ExcelUtils.exportExcelToTarget(response, null, list, ArticleCategoryExcel.class);
    }
