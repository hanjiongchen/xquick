  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-log__error">
      ...
      <el-table v-loading="dataListLoading" :data="dataList" border @sort-change="dataListSortChangeHandle" style="width: 100%;">
        ...
        <el-table-column prop="params" label="参数" header-align="center" align="center" min-width="150" class-name="nowrap">
          <template slot-scope="scope">
            <el-link type="primary" @click="jsonViewHandle(scope.row.params)" :underline="false">{{ scope.row.params }}</el-link>
          </template>
        </el-table-column>
        <el-table-column prop="content" label="异常信息" header-align="center" align="center" min-width="150" class-name="nowrap">
          <template slot-scope="scope">
