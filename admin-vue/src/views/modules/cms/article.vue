        ...
        <div class="mod-cms__article}">
            <el-form :inline="true" :model="dataForm">
                <el-form-item class="small-item">
                    <el-select v-model="dataForm.articleCategoryId" placeholder="分类" style="width: 100%" clearable>
                        <el-option v-for="item in articleCategoryList" :key="item.id" :label="item.name" :value="item.id"/>
                    </el-select>
                </el-form-item>
                <el-form-item class="small-item">
                    <el-select v-model="dataForm.status" placeholder="状态" class="w-percent-100">
                        <el-option
                ...
                <el-form-item class="small-item">
                    <el-select v-model="dataForm.top" placeholder="首页推荐" class="w-percent-100">
                        <el-option
                ...
                <el-form-item class="small-item">
                    <el-input v-model="dataForm.name" placeholder="标题" clearable/>
                </el-form-item>
                <el-form-item>
                    <el-input v-model="dataForm.content" placeholder="文章内容" clearable/>
                </el-form-item>
                <el-form-item>
                ...
                <el-table-column prop="content" label="文章内容" header-align="center" align="center" min-width="200" class-name="nowrap">
                    <template slot-scope="scope">
                        <el-popover
                                ...
                                width="400"
                                trigger="click">
                            <div v-html="scope.row.content" class="scrollable"></div>
                            <el-link slot="reference" type="primary" :underline="false" class-name="nowrap" v-text="scope.row.content"/>
                        </el-popover>
                    </template>
                </el-table-column>
