  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-shop__receiver}">
      ...
      <el-table v-loading="dataListLoading" :data="dataList" border @selection-change="dataListSelectionChangeHandle" @sort-change="dataListSortChangeHandle" style="width: 100%;">
        ...
        <el-table-column prop="regionName" label="区域名称,如浙江省,宁波市,鄞州区" header-align="center" align="center"></el-table-column>
        <el-table-column prop="regionCode" label="区域编号,如33000,33010,33011" header-align="center" align="center"></el-table-column>
        <el-table-column prop="address" label="详细门牌号" header-align="center" align="center"></el-table-column>
        <el-table-column prop="consignee" label="收件人" header-align="center" align="center"></el-table-column>
        <el-table-column prop="zipCode" label="邮编" header-align="center" align="center"></el-table-column>
        <el-table-column prop="mobile" label="收件人手机号" header-align="center" align="center"></el-table-column>
